...
knitr::opts_chunk$set(echo = F, warning = F, error = F, message = F, fig.width = 12)
```
...
```{r echo = T}
Locations <- 
    getURL("https://raw.githubusercontent.com/rjake/TravellingSalesPerson/master/Medschools.csv") %>%
...
###What to do about groups: ```r ifelse(use_group == T, "use original groups", "clustering algoithm")```
```{r}
if(use_group == F){
